...
int CootLigandEditorCanvas::append_molecule_at_coords(std::shared_ptr<RDKit::RWMol> rdkit_mol, int x, int y) noexcept {
    return coot_ligand_editor_canvas_append_molecule_at_coords(this, std::move(rdkit_mol), x, y);
}
